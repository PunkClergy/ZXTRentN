    ...
    <view class="content-container" :style="{
      ...
      <view class="main-content-container">
        ...
        <scroll-view scroll-y class="right-content" :scroll-top="scrollTop" 
                     @scroll="onScroll" scroll-with-animation>
          <view v-for="(item, index) in main_coverage" :key="index" 
                class="right-category" :id="`category-${index}`">
            <view class="category-title">{{ item.name }}</view>
            <view class="child-grid">
              <view v-for="(citem, cindex) in item.children" :key="cindex" 
                    class="child-item" @tap="handleChildItemTap(citem)">
