...
(() => {
    ...
    const CONFIG = {
        ...
        BUTTONS: [
            { id: 'btn1', type: 1, label: '锁门' },
            { id: 'btn3', type: 3, label: '开门' },
            { id: 'btn5', type: 5, label: '寻车' },
            { id: 'btnReturn', type: 'btnReturn', label: '归还车辆' },
            { id: 'btnSee', type: 'btnSee', label: '查看照片' },
            { id: 'btn8', type: 8, label: '风控拦截' },
            { id: 'btn6', type: 6, label: '取消风控' }
        ],
        VISIBILITY: {
    ...
    const updatePosition = (lat, lng, isCar = false) => {
        Object.assign(state.position, { lat, lng });
    ...
    const setupEventListeners = () => {
        CONFIG.BUTTONS.forEach(({ id, type }) => {
